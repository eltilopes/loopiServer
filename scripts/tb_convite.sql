...
(
  ...
  ds_chave character varying(256) NOT NULL,
  ...
  CONSTRAINT uq_chave_convite UNIQUE (ds_chave),
  CONSTRAINT uq_chave_usuario_email_cpf_convite UNIQUE (cd_usuario_mobile, ds_email,nr_cpf,ds_chave)
)
WITH (
  OIDS=FALSE
);
